...
public class BishopSprite extends Sprite {
	/**
	 * 
	 */
	private static final long serialVersionUID = -724040638690654120L;
	private static final int leftBorder = 5, vertBorder = 3; // magic numbers for the sheet
	...
	public BishopSprite(){
		if (sheet == null) // load the sprite sheet into memory
			try{
				sheet = ImageIO.read(new File("images/BishopWalkingAlpha.png"));
			}catch(Exception e){};
