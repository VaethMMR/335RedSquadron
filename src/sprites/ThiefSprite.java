...
public class ThiefSprite extends Sprite {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2233205202839435064L;
	...
	public ThiefSprite(){
		if (sheet == null) // load the sprite sheet into memory
			try{
				sheet = ImageIO.read(new File("images/ThiefWalkingAlpha.png"));
			}catch(Exception e){};
