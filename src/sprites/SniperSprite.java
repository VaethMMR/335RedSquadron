...
public class SniperSprite extends Sprite {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 2686177288621741261L;
	...
	public SniperSprite(){
		if (sheet == null) // load the sprite sheet into memory
			try{
				sheet = ImageIO.read(new File("images/SniperWalkingAlpha.png"));
			}catch(Exception e){};
