...
public class LanceCasterSprite extends Sprite {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4012195429287306170L;
	private static final int leftBorder = 1, vertBorder = 6; // magic numbers for the sheet
	private static final int MAX_FRAMES = 4; // more magic numbers
	private static final int width = 32, height = 30; // width and height of a single frame
	...
	public LanceCasterSprite(){
		if (sheet == null) // load the sprite sheet into memory
			try{
				sheet = ImageIO.read(new File("images/lordephraimWalkingAlpha.png"));
			}catch(Exception e){};
