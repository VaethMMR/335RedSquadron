...
public class SwordmasterSprite extends Sprite {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1491367919876872787L;
	...
	private static final int width = 32, height = 40; // width and height of a single frame
	...
	public SwordmasterSprite(){
		if (sheet == null) // load the sprite sheet into memory
			try{
				sheet = ImageIO.read(new File("images/SwordmasterWalkingAlpha.png"));
			}catch(Exception e){};
